...
export default class GlobalHeaderRight extends PureComponent {
  ...
  render() {
    ...
    const currentUsers = login.currentUsers || list.currentUsers;
    const menu = (
    ...
    return (
      <div className={className}>
        ...
        {currentUsers && currentUsers.profile ? (
          <HeaderDropdown overlay={menu}>
            <span className={`${styles.action} ${styles.account}`}>
              <Avatar
                ...
                alt="avatar"
              />
              <span className={styles.name}>{currentUsers.profile.firstName}</span>
            </span>
          </HeaderDropdown>
        ) : (
