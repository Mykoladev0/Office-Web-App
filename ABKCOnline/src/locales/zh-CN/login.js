export default {
  ...
  // new
  'form.mail.placeholder': '电子邮件',
  'validation.firstName.required': '请输入您的名字',
  'form.firstName.placeholder': '名字',
  'validation.lastName.required': '请输入您的姓氏',
  'form.lastName.placeholder': '姓',
  'form.role.placeholder': '选择角色',
  'form.phone-number.label': '电话',
  'form.firstName.label': '名字',
  'form.lastName.label': '姓',
};
