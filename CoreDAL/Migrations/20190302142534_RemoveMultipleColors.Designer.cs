...
namespace CoreDAL.Migrations
{
    ...
    [Migration("20190302142534_RemoveMultipleColors")]
    partial class RemoveMultipleColors
    {
            ...
            modelBuilder.Entity("CoreDAL.Models.v2.Registrations.PuppyRegistrationModel", b =>
                {
                    ...
                    b.Property<int?>("NewCoOwnerOwnerId");

                    b.Property<int?>("NewOwnerOwnerId");
                    ...
                    b.HasIndex("NewCoOwnerOwnerId");

                    b.HasIndex("NewOwnerOwnerId");
            ...
            modelBuilder.Entity("CoreDAL.Models.v2.Registrations.PuppyRegistrationModel", b =>
                {
                    ...
                    b.HasOne("CoreDAL.Models.Owners", "NewCoOwner")
                        .WithMany()
                        .HasForeignKey("NewCoOwnerOwnerId");

                    b.HasOne("CoreDAL.Models.Owners", "NewOwner")
                        .WithMany()
                        .HasForeignKey("NewOwnerOwnerId");
