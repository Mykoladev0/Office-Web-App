...
namespace CoreDAL.Migrations
{
    ...
    [Migration("20190330160141_litterRegistration")]
    partial class litterRegistration
    {
            ...
            modelBuilder.Entity("CoreDAL.Models.v2.Registrations.LitterRegistrationModel", b =>
                {
                    ...
                    b.HasOne("CoreDAL.Models.v2.AttachmentModel", "DamSignature")
                        .WithMany()
                        .HasForeignKey("DamSignatureId");
